...
pub async fn variantdatabase(
    ...
    let database_url = env::var(database).expect("database not present");
    let databasepool = PgPool::connect(&database_url).await?;
    let fileopen = File::open(path1).expect("file not found");
    let fileread = BufReader::new(fileopen);
    let binding = path1.to_string();
    let _filename = binding.split(".").collect::<Vec<_>>();
...
$100)").bind(i.chrom.clone()).bind(i.start.clone()).bind(i.stop.clone()).bind(i.priortranscript.clone()).bind(i.hgvpc.clone()).bind(i.cannonical.clone()).bind(i.othertranscript.clone()).bind(i.genotype.clone()).bind(i.phenotype.clone()).bind(i.medgencui.clone()).bind(i.inheritance.clone()).bind(i.finalclass.clone()).bind(i.score_pathogen.clone()).bind(i.flag.clone()).bind(i.note.clone()).bind(i.vcforig.clone()).bind(i.pvs1.clone()).bind(i.ps1.clone()).bind(i.ps2.clone()).bind(i.ps3.clone()).bind(i.ps4.clone()).bind(i.pm1.clone()).bind(i.pm2.clone()).bind(i.pm3.clone()).bind(i.pm4.clone()).bind(i.pm4.clone()).bind(i.pm5.clone()).bind(i.pm6.clone()).bind(i.pp1.clone()).bind(i.pp2.clone()).bind(i.pp3.clone()).bind(i.pp4.clone()).bind(i.pp5.clone()).bind(i.ba1.clone()).bind(i.bs1.clone()).bind(i.bs2.clone()).bind(i.bs3.clone()).bind(i.bs4.clone()).bind(i.bs4.clone()).bind(i.bp1.clone()).bind(i.bp2.clone()).bind(i.bp3.clone()).bind(i.bp4.clone())
.bind(i.bp4.clone()).bind(i.bp5.clone()).bind(i.bp6.clone()).bind(i.bp7.clone()).bind(i.bp8.clone()).bind(i.effect.clone()).bind(i.transcript.clone()).bind(i.selectcannonical.clone()).bind(i.tfbsid.clone()).bind(i.tfbsname.clone()).bind(i.exonintronnum.clone()).bind(i.hgvsc.clone()).bind(i.cdsdistance.clone()).bind(i.cdslen.clone()).bind(i.aalen.clone()).bind(i.othertranscript.clone()).bind(i.exac_an.clone()).bind(i.exac_ac.clone()).bind(i.exac_af.clone()).bind(i.exac_istarget.clone()).bind(i.dnsnp.clone()).bind(i.dnsnp_version.clone()).bind(i.dbsnp_1tgp_ref_freq.clone()).bind(i.dbsnp_1tgp_alt_freq.clone()).bind(i.common_1tgp_1perc.clone()).bind(i.esp6500siv2_ea_freq.clone()).bind(i.esp6500siv2_aa_freq.clone()).bind(i.esp6500siv2_all_freq.clone()).bind(i.gnomad_af_all.clone()).bind(i.gnomad_hom_all.clone()).bind(i.gnomad_af_max_pop.clone()).bind(i.cadd_score.clone()).bind(i.dbscsnv_ab_score.clone()).bind(i.dbscsnv_rf_score.clone()).bind(i.papi_pred.clone()).bind(i.papi_score.clone()).bind(i.polyphen_2_pred.clone()).bind(i.polyphen_2_score.clone()).bind(i.sift_pred.clone()).bind(i.sift_score.clone()).bind(i.pseeac_rf_pred.clone()).bind(i.pseeac_rf_score.clone()).bind(i.clinvar_hotspot.clone()).bind(i.clinvar_rcv.clone())
    .bind(i.clinvar_clinical_significance.clone()).bind(i.clinvar_rev_status.clone()).bind(i.clinvar_traitsclinvar_pmids.clone()).bind(i.diseases.clone()).bind(i.disease_ids.clone()).bind(i.aml_0156_dna131_geno.clone()).bind(i.aml_0156_dna131_qual.clone())
    .bind(i.aml_0156_dna131_geno_qual.clone()).bind(i.aml_0156_dna131_filter.clone()).bind(i.aml_0156_dna131_af.clone()).bind(i.aml_0156_dna131_ao.clone()).bind(i.aml_0156_dna131_ro.clone()).bind(i.aml_0156_dna131_co.clone()).execute(&databasepool).await?;
    }
